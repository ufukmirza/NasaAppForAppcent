package com.example.nasaappforappcent.Nasa.curiosity.adapter
...
class CuriosityAdapter  : PagingDataAdapter<Curiosity,
        CuriosityAdapter.ImageViewHolder>(diffCallback) {
    ...
    companion object {
        val diffCallback = object : DiffUtil.ItemCallback<Curiosity>() {
            override fun areItemsTheSame(oldItem: Curiosity, newItem: Curiosity): Boolean {
                return oldItem.id == newItem.id
            }

            override fun areContentsTheSame(oldItem: Curiosity, newItem: Curiosity): Boolean {
